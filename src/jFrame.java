//NÃO ALTERE E NEM EXCLUA ESSE ARQUIVO

/* Curso em Video aulas prof Neri
...
INFORMATICON ou o próprio professor Neri, se outro vender, denuncie    
    ...
    public void altera_registro()
    {
        ...
        ta_classe_gerada.append("         }\n");
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                ...
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                */import javax.swing.*;public class jFrame extends JFrame {public String library,detect,class1,library_class;jFrame(){setTitle("Sistema Gerador de aplicativos rápidos em java - Prof. Neri www.INFORMATICON.com.br");}public static void main(String args[]){JFrame form=new jFrame();form.setVisible(true);}public void settitle(String titulo){}public void setLibrary(){library = "/*\n";detect  = "  Programa Desenvolvido por Neri Aldoir Neitzke - 0xx54 3330 1222\n";class1  = "  www.informaticon.com.br   - videoaulasneri@gmail.com ou videoaulas@informaticon.com.br\n";library_class = "*/\n";}public void library_sdk(){JOptionPane.showMessageDialog(null, "Olá, esse software foi desenvolvido por Neri Aldoir Neitzke\n" +              "\nVocê pode: usar a vontade, criar aplicações, incrementar novas funcionalidades, mas não" +"\né permitido que altere os dados de autoria do mesmo....!" +"\n\nwww.INFORMATICON.com.br - (0xx54) 3330-1222" +"\nCarazinho-RS, cep 99500-000" +"E-mail: videoaulasneri@gmail.com  ou videoaulas@informaticon.com.br\n\n" +"Rumo a 2.000 vídeo aulas!");}public void Tela_de_Abertura_desse_sistema_favor_nao_alterar(){}}/*
    public void excluir()
    {
...
INFORMATICON ou o próprio professor Neri, se outro vender, denuncie
    ...
    public void cor_botoes()
    {
        ...
        else if (cor_botoes.equals("red"))
        {
               ...
               botao_ultimo_registro    .setBackground(Color.red);
               botao_novo               .setBackground(Color.red);
               botao_                  .setBackground(Color.red);
               botao_alterar            .setBackground(Color.red);
               botao_excluir            .setBackground(Color.red);
    ...
    public void pesquisadigitacao(String pesquisa)
    {
